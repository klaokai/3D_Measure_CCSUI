...
/*!
  ...
  \endif
*/
#define MCHR_MAX_EXPOSURE_CHR_XE   30000   /* Correspond à la Freq 33Hhz */
										   /* Corresponds to 33Hz */
/*!
  \def MCHR_MIN_EXPOSURE_CHR_XE
  \if FR
	 Definition du temps d'exposition MINIMUM pour un CHR XE.
	 100 correspond à la fréquence 10 KHz.
  \else
...
/*!
  ...
  \if FR
	 ...
	 10000 correspond à la fréquence 100 Hz.
  \else
	 MAXIMUM exposure time in microsec for CHR CCS INITIAL. <br>
	 10000 correspond to the frequency 100 Hz.
  \endif
*/
#define MCHR_MAX_EXPOSURE_CCS_INITIAL 10000  /* Correspond à la Freq 100Hhz */
...
/*!
  ...
  \if FR
	 ...
	 10000 correspond à la fréquence 100Hz.
  \else
	 MAXIMUM exposure time in microsec for CCS PRIMA. <br>
	 10000 correspond to the frequency 100Hz.
  \endif
*/
#define MCHR_MAX_EXPOSURE_CCS_PRIMA 10000	/* Correspond à la Freq 100Hhz */
											/* Corresponds to 100Hz */
/*!
...
/*!
  ...
  \endif
*/
#define MCHR_MAX_EXPOSURE_CCS_OPTIMA 10000		/* Correspond à la Freq 100Hhz */
													/* Corresponds to 100Hz */
/*!
  \def MCHR_MIN_EXPOSURE_CCS_OPTIMA
  \if FR
	 Definition du temps d'exposition MINIMUM pour un CCS OPTIMA.
	 200 correspond à la fréquence 5 KHz.
  \else
...
/*!
  ...
  \endif
*/
#define MCHR_MAX_EXPOSURE_CCS_ULTIMA 10000		/* Correspond à la Freq 100Hhz */
													/* Corresponds to 100Hz */
/*!
...
/*!
  ...
  \if FR
	 ...
	 25000 correspond à la fréquence 40Hz.
  \else
	 MAXIMUM exposure time in microsec for TRIO. <br>
	 25000 correspond to the frequency 40Hz.
  \endif
*/
#define MCHR_MAX_EXPOSURE_TRIO 25000		/* Correspond à la Freq 40Hz */
/*!
  ...
  \endif
*/
#define MCHR_MIN_EXPOSURE_TRIO 500			/* Correspond à la Freq 2000Hhz */
/*!
  ...
  \endif
*/
#define MCHR_MAX_EXPOSURE_RUBY 250000L		/* Correspond à la Freq 100Hhz */
/*!
  \def MCHR_MIN_EXPOSURE_CHR_450
  \if FR
  ...
  \endif
*/
#define MCHR_MIN_EXPOSURE_RUBY 500		/* Correspond à la Freq 2Khz */
