...
typedef enum
{
	...
	MCHR_TYPE_NONE,
	/*! \brief 
				\if FR  : Commence quand l'impulsion Trig est reçu, sans ré-armer
				\else : Start when a Trig pulse is received, do not re-arm
				\endif
	*/ 
	MCHR_TYPE_TRG,
	/*! \brief 
				\if FR  : Débute ou stop la mesure dès la réception de 3 impulsions Trig et ré-arme
...
{
#endif
	/*! \if FR Correspond à l'evenement d'acquisition du point de la structure. \else Corresponds to EventAcquire_n_Points of this structure. \endif */
	MCHR_ONE_STEP_EVENT,
...
/*! \enum enRealTimeSignalType
	\brief
		\if FR 
			\brief Selection du type de spectre envoyé en temps reel 
...
{
	/*
	Nombre de points à acquerir. Si la valeur vaut 0 l'acquisition se fera en continu
   ...
   /* 
   Nombre d'image à acquerir en mode TRE
   ...
   */
   ...
   DWORD NumberPointsTRE;
	...
	/*
	Indique le nombre de buffers pour les differents types de donnees. Ce paramètre doit être superieur à 0. 
	...
	*/
	...
	/*
	Definie le nombre de points à acquerir avant de signaler un evenement.
