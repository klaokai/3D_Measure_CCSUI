...
//---------------------------------------------------------------------------------
bool CCSWork::OpenSensor(MCHR_ID *pSensorID, enChrType SensorType)
{
...
//-----------------------------------------------------------------------------------------
bool CCSWork::CreateEvents(cAcqEasy *pAcquisitionEasy, HANDLE* pAcquisitionEvent)
{	
...
//-----------------------------------------------------------------------------------------
void CCSWork::ReleaseEvents(HANDLE *pAcquisitionEvent)
{
	if (*pAcquisitionEvent != NULL)
	{
...
//---------------------------------------------------------------------------------
bool CCSWork::StartAcquisition(cAcqEasy *pAcquisitionEasy, sAcqEasyParam acqEasyParameters)
{
	if (pAcquisitionEasy == NULL)
	{
...
//---------------------------------------------------------------------------------
bool CCSWork::CloseSensor(MCHR_ID SensorID)
{
	if (SensorID > 0)
	{
...
//---------------------------------------------------------------------------------
bool CCSWork::SetParameter(MCHR_ID SensorID,int intensity,int frequency,int average,int holdlast)
{
...
//---------------------------------------------------------------------------------
short CCSWork::Process(cAcqEasy *pAcquisitionEasy, HANDLE AcquisitionEvent, sAcqEasyParam acqEasyParameters, float* pAltitude, float* pIntensity,int* pDataCount)
{
	if (pAcquisitionEasy == NULL)
	{
